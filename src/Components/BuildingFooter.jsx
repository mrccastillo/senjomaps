...
function BuildingFooter({
  ...
  function handleSaveSubmit() {
    ...
    if (!isAlreadySaved) {
      // Append the new mapData to the existing saved places
      ...
      console.log("New mapData appended to saved places successfully.");
      console.log(mapData);
    } else {
      setIsSaved(true);
      console.log(
        "MapData already exists in saved places and was not appended."
      );
    }
  }
                    ...
                    return (
                      <>
                        <iframe
                          ...
                          title="Openfield"
                          className="panorama --pano-clicked"
                        ></iframe>
                ...
                switch (true) {
                  ...
                  case tempBuildingId === 8:
                    return (
                      <>
                        <div className="building-rooms">
                          <div className="room claire-room"></div>
                        </div>
                        <div className="building-sign"></div>
                      </>
                    );
                  ...
                  case tempBuildingId === 10:
                    return (
                      <>
                        <div className="building-rooms"></div>
                        <div className="building-sign"></div>
                      </>
                    );
                  case tempBuildingId === 11:
